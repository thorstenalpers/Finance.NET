...
public class ServiceCollectionExtensionsTests
{
    ...
    public void AddFinanceServices_WithCfg_Added()
    {
        ...
        var userAgent = clientDatahubIo.DefaultRequestHeaders.GetValues(Constants.HeaderUserAgent).FirstOrDefault();
        ...
        userAgent = clientAlphaVantage.DefaultRequestHeaders.GetValues(Constants.HeaderUserAgent).FirstOrDefault();
        Assert.That(userAgent, Is.Not.Empty);
        ...
        userAgent = clientXetra.DefaultRequestHeaders.GetValues(Constants.HeaderUserAgent).FirstOrDefault();
        Assert.That(userAgent, Is.Not.Empty);
        ...
        userAgent = clientYahoo.DefaultRequestHeaders.GetValues(Constants.HeaderUserAgent).FirstOrDefault();
        Assert.That(userAgent, Is.Not.Empty);
